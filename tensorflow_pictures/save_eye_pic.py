...
while i<100:
    ...
    # 画像の保存
    # 左
    # cv2.imwrite('r_eye_left/'+str(i)+'.jpg',r_frame_black_white)
    # cv2.imwrite('l_eye_left/'+str(i)+'.jpg',r_frame_black_white)
    
    # 右
    # cv2.imwrite('r_eye_right/'+str(i)+'.jpg',r_frame_black_white)
    # cv2.imwrite('l_eye_right/'+str(i)+'.jpg',r_frame_black_white)
    
    # 上
    # cv2.imwrite('r_eye_up/'+str(i)+'.jpg',r_frame_black_white)
    # cv2.imwrite('l_eye_up/'+str(i)+'.jpg',r_frame_black_white)
    
    # 下
    # cv2.imwrite('r_eye_down/'+str(i)+'.jpg',r_frame_black_white)
    # cv2.imwrite('l_eye_down/'+str(i)+'.jpg',r_frame_black_white)

    # 閉じる
    # cv2.imwrite('r_eye_close/'+str(i)+'.jpg',r_frame_black_white)
    # cv2.imwrite('l_eye_close/'+str(i)+'.jpg',r_frame_black_white)
